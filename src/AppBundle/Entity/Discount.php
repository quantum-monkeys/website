...
class Discount implements TranslatableInterface
{
    ...
    public function addTranslation(DiscountTranslation $serviceTranslation)
    {
        $serviceTranslation->setDiscount($this);
